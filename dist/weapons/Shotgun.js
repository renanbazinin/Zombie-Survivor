...
export class Shotgun extends Weapon {
    ...
    fire(game) {
        ...
        for (let i = 0; i < this.stats.projectileCount; i++) {
            ...
            const projectile = new Projectile(this.owner.position.x, this.owner.position.y, angle, this.stats.projectileSpeed, this.stats.damage, this.stats.range, this.stats.pierce, '#ff8800');
